...
num_waypoints = 20  # Number of additional waypoints
radius = 100.0  # Radius of the curve

for i in range(1, num_waypoints + 1):
    angle = i * (2 * math.pi / num_waypoints)  # Angle between waypoints
    x = 2400.0 + radius * math.cos(angle)  # X-coordinate of the waypoint
    y = 0.0 + radius * math.sin(angle)  # Y-coordinate of the waypoint
